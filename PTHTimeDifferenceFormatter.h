...
@property(nonatomic, getter=isFutureDate) _Bool futureDate; // @synthesize futureDate=_futureDate;
@property(copy, nonatomic) NSString *nowString; // @synthesize nowString=_nowString;
@property(nonatomic) _Bool longFormat; // @synthesize longFormat=_longFormat;
- (void).cxx_destruct;
