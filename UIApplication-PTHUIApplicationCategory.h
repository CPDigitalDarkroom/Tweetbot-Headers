...
- (void)animateStatusBar:(long long)arg1;
- (void)animateStatusBar:(long long)arg1 duration:(double)arg2 completion:(CDUnknownBlockType)arg3;
- (void)dispatchUIDelayed:(CDUnknownBlockType)arg1;
- (void)dispatchBackgroundTaskInQueue:(id)arg1 block:(CDUnknownBlockType)arg2;
